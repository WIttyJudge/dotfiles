...
function on_attach(client, bufnr)
  ...
  map("n", "<Leader>ar", function() vim.lsp.buf.rename() end)

  map("n", "<Leader>ee", function() vim.diagnostic.open_float() end)
  map("n", "<Leader>ej", function() vim.diagnostic.goto_next() end)
  map("n", "<Leader>ek", function() vim.diagnostic.goto_prev() end)
end
